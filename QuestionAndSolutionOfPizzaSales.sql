...
order by cum_revenue desc limit 5;


-- Determine the top 5 most ordered pizza types based on
-- revenue for each pizza category.

select name , revenue from 
(select category , name , revenue, rank() over(partition 
 by category order by revenue desc) as rn from
